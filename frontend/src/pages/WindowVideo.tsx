              ...
              <div className="bg-me-lightpurple rounded-lg px-3 py-2 mt-4">
                <div className="flex items-start mt-4">
                  <div className="w-">
                    ...
                    <div className="flex mb-4">
                      <div className="flex-shrink-0 mr-2">
                        <img src={require('../assets/valerie.jpg')} alt="Logo de chaîne" className="rounded-full w-8 h-8 object-center" />
                      </div>
                      <div className="flex-1">
                    ...
                    <div className="flex mb-4">
                      <div className="flex-shrink-0 mr-2">
                        <img src={require('../assets/colombe.jpg')} alt="Logo de chaîne" className="rounded-full w-8 h-8 object-center" />
                      </div>
                      <div className="flex-1">
                        <div className="flex justify-between">
                    ...
                    <div className="flex mb-4">
                      <div className="flex-shrink-0 mr-2">
                        <img src={require('../assets/musk.jpg')} alt="Logo de chaîne" className="rounded-full w-8 h-8 object-center" />
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center">
