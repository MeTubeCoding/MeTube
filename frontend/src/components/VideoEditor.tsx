<<<<<<< HEAD:src/components/VideoEditor.tsx
...
>>>>>>> 3e6b1aa594d5d0812ed4a75da42e30cd001b15fd:frontend/src/components/VideoEditor.tsx
...
<<<<<<< HEAD:src/components/VideoEditor.tsx
      ...
      <div style={{ display: 'flex', flexDirection: 'row' }}>
        <div style={{ display: 'flex', flexDirection: 'column', marginRight: 20 }}>
          ...
          <Button onClick={handleSaveVideo}>Cut</Button>
