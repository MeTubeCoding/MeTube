        ...
        <div className="w-full md:w-1/2 pl-24 max-w-xl mx-auto px-2 py-8">
          <form onSubmit={handleSubmit} className="max-w-md w-full px-6">
            <div className="flex flex-col items-center justify-center bg-white rounded-lg shadow-lg p-10">
              ...
              <p className="pl-1 mt-5 text-sm text-gray-500">
                    ...
                    <div className="border-t border-gray-200 mt-8 pt-4 bg-gray-100 p-4 rounded-lg">
                      ...
                      <div>
                        <label
                          ...
                          className="flex items-center cursor-pointer mb-2 radio-button"
                        >
                          <input
                            type="radio"
                            id="check-comments"
                        ...
                        <div>
                          <label
                            ...
                            className="ml-5 flex items-center cursor-pointer mb-2"
                          >
                            <input
                              type="checkbox"
                              id="severe-comments"
                            ...
                            >
                              Increase severity{' '}
                              <span className="text-red-600 bg-red-100 px-1 rounded-md">
                                Test
                              </span>
                            </span>
                          </label>
                      ...
                      <div className="mt-4">
                        ...
                        >
                          ...
                          />
                          <span>
                            Display the number of &quot;likes&quot; for this
                            video
                          </span>
                        </label>
                      </div>
