        ...
        <div>
          ...
          <div className="relative mb-4 overflow-hidden group">
            ...
            <div className="absolute text-xs mr-0 left-72 top-20 text-gray-400">
              ...
              ▶Twitter : https://twitter.com/Julgane
              ▶Speedrun : https://www.speedrun.com/user/Julgane

              Montage par: https://twitter.com/Fast_z34 & Moi

              #Julgane #Speedrun #React
            </div>
            <div className="bg-neutral-900 object-cover absolute top-28 ml-72 left-0 bottom-0 right-0"></div>
            <div className="bg-neutral-900 absolute h-12 w-20 right-0 -top-0">
              <div id="croix" className="hidden group-hover:block">
          ...
          <div className="relative mb-4 overflow-hidden group">
            ...
            <div className="absolute text-xs mr-0 left-72 top-20 text-gray-400">
              ...
              Teromik : https://twitter.com/leTeromik
              Mai-Lie : https://twitter.com/MaiLieBaelish
              Nox : https://twitter.com/MrElNox

              ▼▼ DÉROULE LA DESCRIPTION ▼▼
              💃 TikTok  ► https://www.tiktok.com/@trasheurs
              😂 Facebook ► https://www.facebook.com/trasheurs.vi...
          ...
          <div className="relative mb-4 overflow-hidden group">
            ...
            <div className="absolute text-xs mr-0 left-72 top-20 text-gray-400">
              ...
              État de la run à la sortie du TEC :
              - Aventure principale terminée 
              - Jeu terminé 
              - 29h de jeu 
              ...
              - Pokémon XD - ONBS 
              - Harry Potter - Flute 
              - Joakim Karud - Classic (outro de la chaîne) 

              --------------------------------------------------------------------------

              Crédits :

              Le SoundCloud de Joakim Karud : https://soundcloud.com/joakimkarud

              Le Youtube de Joakim Karud :   

               / joakimkarud  

              Le profil Artist Union de Joakim Karud : https://theartistunion.com/joakimkarud
          ...
          <div className="relative mb-4 overflow-hidden group">
            ...
            <div className="absolute text-xs mr-0 left-72 top-20 text-gray-400">
              ...
              Twitch : https://www.twitch.tv/ego_
              Twitter : https://twitter.com/rl_ego
              TikTok : https://www.tiktok.com/@ego_rl1
              Discord : https://discord.gg/             uufH7HXYh2                                                                                                                                
              Mail : ego.pro003@gmail.com
              ...
              3. Sticky Finger - Ballpoint
                                                                                                                                   
              _

              Miniature par Nekatt : https://www.behance.net/jc161

              _
                                                                                                                                                                                    
              #rocketleague  #rlcs  #esports
            </div>
            <div className="bg-neutral-900 object-cover absolute top-28 ml-72 left-0 bottom-0 right-0"></div>
            <div className="bg-neutral-900 absolute h-12 w-20 right-0 -top-0">
              <div id="croix" className="hidden group-hover:block">
