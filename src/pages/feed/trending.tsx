...
function Tendances() {
  return (
    <div className="h-full text-me-yellow font-sans-roboto font-normal text-base leading-relaxed text-left m-0 p-0 h-screen">
      <div className="flex flex-row justify-center h-screen bg-neutral-900  ">
        ...
        <div>
          ...
          <div className="w-full ml-5 flex flex_col justify-center  ">
            {trend_new()}
            {trend_music()}
            {trend_gaming()}
            {trend_movies()}
